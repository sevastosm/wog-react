...
export default function Banners() {
    ...
    <a id="ctl00_main_adv1" title="Έσχατες ημέρες. Αλήθεια ή ψέμα" href="https://www.wordofgod.gr/pdf/latter_days_GR_new.pdf" target="_blank"><img title="Έσχατες ημέρες. Αλήθεια ή ψέμα" src="https://www.wordofgod.gr/images/esxates_gr_new.png" alt=""/></a>
    </div>
    <div className="w-100 d-flex justify-content-center">
     <div className="m-3 ">
